...
New-Item -ItemType SymbolicLink -Force -Path "C:\Users\$currentUser\AppData\Roaming\Hyper\.hyper.js" -Target "C:\Users\$currentUser\.config\dotfiles\shell\.hyper.js"
